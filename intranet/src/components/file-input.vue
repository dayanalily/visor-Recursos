<template>
  ...
  >
    <div class="c-file-input__indicator">
      <span class="c-file-input__indicator__icon  ri-attachment-2"></span>
    </div>
    ...
    >
      <span
        class="c-file-input__remove__icon ri-delete-bin-line"
...
export default {
  ...
  methods: {
    fileChangeHandler(e) {
      ...
      this.imagen = this.files[0];

      this.$emit('update',this.imagen);
    },
    clearFileHandler() {
